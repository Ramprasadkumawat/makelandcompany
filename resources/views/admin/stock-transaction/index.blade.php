                    ...
                    <table class="table" id="artists-table">
                      <thead>
                        <tr>
                          ...
                          <th scope="col">Cold Store</th>
                          <th scope="col">Capacity(Bore Count)</th>
                          <th scope="col">Capacity Weight(In Quaintal)</th>
...
<script>
    $(function() {
        ...
        $('#artists-table').DataTable({
            ...
            columns: [
                ...
                {data: 'name', name: 'name'},
                {data: 'coldStoreName', name: 'coldStoreName'},
                {data: 'capacity', name: 'capacity'},
                {data: 'weight', name: 'capacity_weight'},
    ...
    function deleteArtist(id) {
        ...
        if(confirm("Are you sure want to delete ?")){
            ...
            window.location.href = "{{url('admin/delete-cold-store-stock').'/'}}"+id;
        } else { 
            // stop the ajax call
            return false;
        }
