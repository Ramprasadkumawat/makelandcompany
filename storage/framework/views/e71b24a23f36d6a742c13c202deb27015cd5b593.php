...
<div class="container-fluid">
        ...
        <li class="nav-item dropdown">
            <a class="nav-link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <div class="media align-items-center">
                    ...
                    <img alt="Image placeholder" src="http://localhost/makel-and-company/resources/argon/img/theme/team-1-800x800.jpg">
                    </span>
                </div>
            </a>
    ...
    <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            <div class="row">
                <div class="col-6 collapse-brand">
                    <a  href="<?php echo e(url('home')); ?>">
                        <img src="http://localhost/makel-and-company/resources/argon/img/brand/makel_logo.png">
                    </a>
                </div>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo e(url('village')); ?>">
                    <i class="ni ni-tv-2 text-primary"></i> <?php echo e(__('Village')); ?>

                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?php echo e(url('laserac')); ?>">
                    <i class="ni ni-tv-2 text-primary"></i> <?php echo e(__('Laser AC')); ?>
...
<!-- end footer -->
<?php /**PATH F:\wamp64\www\makel-and-company\resources\views/users/index.blade.php ENDPATH**/ ?>